      ...
      container.innerHTML = `
        ...
        <div class="channel-page-wrapper">
          ...
          <div class="channel-page-nav">
            ...
            <div id="channel-page-toolbar" class="channel-tab-toolbar" style="display: ${['videos', 'livestreams', 'vhs'].includes(initialTab) ? 'flex' : 'none'}; flex-wrap: wrap; gap: 12px; align-items: center;">
